...
<div id="myApp">
    ...
    <table id = "myTable2"class="table table-sm table-bordered">
        ...
        <tr v-for="element in ueList">
            ...
            <td><button v-on:click.prevent="(element.email)" class="btn btn-primary">Supprimer</button></td>
        </tr>
    </table>
                        ...
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <form id="app" method="post" >
                                    ...
                                    <div class="form-group">
                                        <label>Nom UE:</label>
                                        <input v-model="activityToAdd.year" class="form-control" />
                                    </div>

                                    <div class="form-group" >
                                        <label>Credit:</label>
                                        <input v-model="activityToAdd.nature" class="form-control"/>
                                    </div>

                                    <div class="form-group" >
                                        <label>duration Exam:</label>
                                        <input v-model="activityToAdd.title" class="form-control"/>
                                    </div>

                                    <div class="form-group">
                                        <label>Discipline:</label>
                                        <textarea v-model="activityToAdd.description" rows="5" cols="50" class="form-control"></textarea>
                                    </div>
